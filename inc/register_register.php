...
<div class="row" style="margin-top:80px">
    ...
    <div id="home" class="tab-pane fade in active">
     <form class="submitphoto_form" id="myForm"  action="ctr/temp.php" onsubmit="return validateForm()" method="post">
                <input type="text"  id="field_username" class="wp-form-control wpcf7-text" placeholder="Your name" name="t_name" required pattern="\w+">
     ...
     <form class="submitphoto_form" id="myForm"  action="ctr/temp_s.php" onsubmit="return validateForm()" method="post">
                <input type="text"  id="field_username" class="wp-form-control wpcf7-text" placeholder="Your name as Login Id" name="s_name" required pattern="\w+">
