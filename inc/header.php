  ...
  <div class="menu_area">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.php">Test <span>Online</span></a>              
          <!-- IMG BASED LOGO  -->
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <?php 
              if(isset($_SESSION['tempName'])){
                if(isset($_SESSION['tempLvl']) and ($_SESSION['tempLvl']==0)) {$link1 = 'student/index.php'; $link2 = 'student/inc/signout.php'; } else { $link1 = 'teacher/index.php'; $link2 = 'teacher/inc/signout.php';} 
                //echo '<li><a href="'.$link.'">'.$name.'</a></li>';
              echo '<li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><span class="glyphicon glyphicon-user"> '.$_SESSION['tempName'].'<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="'.$link1.'">Profile</a></li>
